 ...
 *
 * Three things move when a folder opens — the group's grid track, the chevron's
 ...
 * not overshoot it. A disclosure that overshoots is a list of rows that visibly
