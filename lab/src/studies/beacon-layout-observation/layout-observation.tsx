...
import { BeaconStoreContext } from '#src/components/beacon/context.js';
import { BeaconFollower, BeaconProvider, useBeaconAnchor } from '#src/components/beacon/index.js';
import type { BeaconStore } from '#src/components/beacon/store.js';
import {
  fmt,
  framesText,
  nextFrame,
