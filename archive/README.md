...
| [2026-08-wheel-focus-model](./2026-08-wheel-focus-model/README.md)                               | Should a segmented picker trap focus, and should Left/Right move?            | Never trap; Left/Right steps and clamps, as native does.               |
| [2026-09-resize-observer-frame-timing](./2026-09-resize-observer-frame-timing/README.md)         | Does a measured size have to reach the screen a frame late?                  | No — the observer is on time; deferred writes and rAF drawing are not. |
| [2026-09-scroll-offset-quantization](./2026-09-scroll-offset-quantization/README.md)             | How do we hold anchored content still when its scroll offset is fractional?  | A spacer on a device-aligned step — writes and transforms both hop.    |
